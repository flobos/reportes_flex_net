<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_contrato_ingreso_pagare_ad_normal_presencial.aspx.vb" Inherits="frm_contrato_ingreso_pagare_ad_normal_presencial" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_pagare_ADM_NORMAL_Presencial.rpt">
                <Parameters>
