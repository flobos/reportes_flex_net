<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_carpeta_academica.aspx.vb" Inherits="frm_carpeta_academica" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_carpeta_academica.rpt">
                <Parameters>
                </Parameters>
            </Report>
