<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_informe_matriculas_mensual_x_institucion_detalle.aspx.vb" Inherits="frm_informe_matriculas_mensual_x_institucion_detalle" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_matriculas_semestrales_continua_detalle.rpt">
                <Parameters>
