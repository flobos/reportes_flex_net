<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_informe_matriculas_mensual_x_institucion_detalle_tipo.aspx.vb" Inherits="frm_informe_matriculas_mensual_x_institucion_detalle_tipo" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_matriculas_semestrales_continua_detalle_tipo.rpt">
                <Parameters>
                    ...
                    <CR:ControlParameter ControlID="inst_edu_nombre" ConvertEmptyStringToNull="False" DefaultValue=""
                        Name="@inst_edu_nombre" PropertyName="Text" ReportName="" />    
                    <CR:ControlParameter ControlID="tip_prod_nombre" ConvertEmptyStringToNull="False" DefaultValue=""
                        Name="@tip_prod_nombre" PropertyName="Text" ReportName="" />    
                </Parameters>
                <DataSources>
       ...
       <asp:TextBox ID="inst_edu_nombre" runat="server" Visible="False"></asp:TextBox>
       <asp:TextBox ID="tip_prod_nombre" runat="server" Visible="False"></asp:TextBox>
    </form>
</body>
</html>