<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_informe_matriculas_diarias_pregrado_detalle.aspx.vb" Inherits="frm_informe_matriculas_diarias_pregrado_detalle" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_matriculas_diarias_pregrado_detalle.rpt">
                <Parameters>
                    ...
                    <CR:ControlParameter ControlID="eje_nombre" ConvertEmptyStringToNull="False" DefaultValue=""
                        Name="@eje_nombre" PropertyName="Text" ReportName="" /> 
                    ...
                    <CR:ControlParameter ControlID="tipo_conteo" ConvertEmptyStringToNull="False" DefaultValue=""
                        Name="@tipo_conteo" PropertyName="Text" ReportName="" />       
                </Parameters>
                <DataSources>
        ...
        <asp:TextBox ID="eje_nombre" runat="server" Visible="False"></asp:TextBox>
        ...
        <asp:TextBox ID="tipo_conteo" runat="server" Visible="False"></asp:TextBox>
    </form>
</body>
</html>