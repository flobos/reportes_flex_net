<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_informe_matriculas_anuales_pregrado_semestre_tipo.aspx.vb" Inherits="frm_informe_matriculas_anuales_pregrado_semestre_tipo" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_matriculas_semestrales_pregrado_tipo.rpt">
                <Parameters>
