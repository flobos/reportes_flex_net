<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_certif_notas_alumno_sin_detalle.aspx.vb" Inherits="frm_certif_notas_alumno_sin_detalle" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_certif_notas_alumno_sin_detalle.rpt">
                <Parameters>
