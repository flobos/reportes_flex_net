...
Partial Class frm_resumen_stado_notas_x_tipo_prueba_ejecucion
    Inherits System.Web.UI.Page
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        Me.eje_idn.Text = Me.Request.QueryString("eje_idn").ToString
        Me.est_pru_idn.Text = Me.Request.QueryString("est_pru_idn").ToString
        configura_reporte()
