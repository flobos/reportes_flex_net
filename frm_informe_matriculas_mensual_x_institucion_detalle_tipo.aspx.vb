...
Partial Class frm_informe_matriculas_mensual_x_institucion_detalle_tipo
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.inst_edu_nombre.Text = Me.Request.QueryString("inst_edu_nombre").ToString
        Me.tip_prod_nombre.Text = Me.Request.QueryString("tip_prod_nombre").ToString
        configura_reporte()
