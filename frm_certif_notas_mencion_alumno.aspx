<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_certif_notas_mencion_alumno.aspx.vb" Inherits="frm_certif_notas_mencion_alumno" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_certif_notas_mencion_alumno.rpt">
                <Parameters>
