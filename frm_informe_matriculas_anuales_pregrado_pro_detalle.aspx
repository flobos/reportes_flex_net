<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_informe_matriculas_anuales_pregrado_pro_detalle.aspx.vb" Inherits="frm_informe_matriculas_anuales_pregrado_pro_detalle" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_matriculas_pro_detalle.rpt">
                <Parameters>
