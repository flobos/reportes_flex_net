<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_certif_notas_alumno_titulado.aspx.vb" Inherits="frm_certif_notas_alumno_titulado" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_certif_notas_alumno_titulado.rpt">
                <Parameters>
