<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_certif_alumno_provisional.aspx.vb" Inherits="frm_certif_alumno_provisional" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_certif_alumno_provisional.rpt">
                <Parameters>
