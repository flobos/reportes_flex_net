<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_contrato_ingreso_inscripcion_ad_normal_presencial.aspx.vb" Inherits="frm_contrato_ingreso_inscripcion_ad_normal_presencial" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_contrato_ADM_NORMAL_Presencial.rpt">
                <Parameters>
