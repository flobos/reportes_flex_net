...
Partial Class frm_reporte_resumen_cuadratura_cajas_sedes
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        ''Me.txt_eje_aca_idn.Text = Me.Request.QueryString("value").ToString

        Me.txt_fecha.Text = Me.Request.QueryString("fecha").ToString
        Me.txt_plazo.Text = Me.Request.QueryString("plazo").ToString
