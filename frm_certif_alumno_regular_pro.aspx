<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_certif_alumno_regular_pro.aspx.vb" Inherits="frm_certif_alumno_regular_pro" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_certif_alumno_regular_pro.rpt">
                <Parameters>
