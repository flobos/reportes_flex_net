<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_certif_seguro_escolar.aspx.vb" Inherits="frm_certif_seguro_escolar" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_certif_seguro_escolar.rpt">
                <Parameters>
