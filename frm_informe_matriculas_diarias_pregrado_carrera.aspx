<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_informe_matriculas_diarias_pregrado_carrera.aspx.vb" Inherits="frm_informe_matriculas_diarias_pregrado_carrera" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_matriculas_diarias_pregrado_carreras.rpt">
                <Parameters>
