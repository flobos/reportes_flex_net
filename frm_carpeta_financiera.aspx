<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_carpeta_financiera.aspx.vb" Inherits="frm_carpeta_financiera" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_carpeta_financiera.rpt">
                <Parameters>
                </Parameters>
            </Report>
