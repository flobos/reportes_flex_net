<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_reporte_acta_rendimiento_academico.aspx.vb" Inherits="frm_reporte_acta_rendimiento_academico" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_acta_rendimiento_academico.rpt">
                <Parameters>
