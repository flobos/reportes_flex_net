...
Partial Class frm_funcionarios_marcaje_incompleto
    Inherits System.Web.UI.Page
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        Me.txt_fecha_inicio.Text = Me.Request.QueryString("fecha_inicio").ToString
        Me.txt_fecha_final.Text = Me.Request.QueryString("fecha_final").ToString
