<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_certif_egresado.aspx.vb" Inherits="frm_certif_egresado" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_certif_egresado.rpt">
                <Parameters>
