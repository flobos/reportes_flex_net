<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_certif_de_emision_de_programas.aspx.vb" Inherits="frm_certif_de_emision_de_programas" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_certif_de_emision_de_programas.rpt">
                <Parameters>
