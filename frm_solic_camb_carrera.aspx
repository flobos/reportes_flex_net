<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_solic_camb_carrera.aspx.vb" Inherits="frm_solic_camb_carrera" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_solic_camb_carrera.rpt">
                <Parameters>
