<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_informe_matriculas_diarias_pregrado.aspx.vb" Inherits="frm_informe_matriculas_diarias_pregrado" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_matriculas_diarias_pregrado.rpt">
                <Parameters>
