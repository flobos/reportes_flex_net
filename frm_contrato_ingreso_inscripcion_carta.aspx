<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_contrato_ingreso_inscripcion_carta.aspx.vb" Inherits="frm_contrato_ingreso_inscripcion_carta" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_pagare_mandato_carta_inscripcion.rpt">
                <Parameters>
