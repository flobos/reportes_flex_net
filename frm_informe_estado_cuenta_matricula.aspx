<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_informe_estado_cuenta_matricula.aspx.vb" Inherits="frm_informe_estado_cuenta_matricula" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_informe_estado_cuenta_matricula.rpt">
                <Parameters>
