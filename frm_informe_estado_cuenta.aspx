<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_informe_estado_cuenta.aspx.vb" Inherits="frm_informe_estado_cuenta" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_informe_estado_cuenta.rpt">
                <Parameters>
