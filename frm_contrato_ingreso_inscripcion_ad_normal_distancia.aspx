<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_contrato_ingreso_inscripcion_ad_normal_distancia.aspx.vb" Inherits="frm_contrato_ingreso_inscripcion_ad_normal_distancia" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_Contrato_Admision_Normal_ADistancia.rpt">
                <Parameters>
