<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_certif_notas_apert_exp_titul.aspx.vb" Inherits="frm_certif_notas_apert_exp_titul" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_certif_notas_apert_exp_titul.rpt">
                <Parameters>
