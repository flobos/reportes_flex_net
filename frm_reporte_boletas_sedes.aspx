<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_reporte_boletas_sedes.aspx.vb" Inherits="_Default" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_cancelacion_boleteo_orden_de_pago_imprime_boleta.rpt">
                <Parameters>
