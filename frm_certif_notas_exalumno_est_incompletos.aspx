<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_certif_notas_exalumno_est_incompletos.aspx.vb" Inherits="frm_certif_notas_exalumno_est_incompletos" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_certif_notas_exalumno_est_incompletos.rpt">
                <Parameters>
