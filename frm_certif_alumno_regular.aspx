<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_certif_alumno_regular.aspx.vb" Inherits="frm_certif_alumno_regular" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_certif_alumno_regular.rpt">
                <Parameters>
