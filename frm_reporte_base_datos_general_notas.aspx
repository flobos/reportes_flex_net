<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_reporte_base_datos_general_notas.aspx.vb" Inherits="frm_reporte_base_datos_general_notas" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_base_datos_general_notas.rpt">
                <Parameters>
