<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_informe_matriculas_anuales_pregrado_pro_x_periodo.aspx.vb" Inherits="frm_informe_matriculas_anuales_pregrado_pro_x_periodo" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_matriculas_pro_tipo.rpt">
                <Parameters>
