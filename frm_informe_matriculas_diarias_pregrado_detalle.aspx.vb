...
Partial Class frm_informe_matriculas_diarias_pregrado_detalle
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.cam_nombre.Text = Me.Request.QueryString("cam_nombre").ToString
        Me.eje_nombre.Text = Me.Request.QueryString("eje_nombre").ToString
        Me.car_nombre.Text = Me.Request.QueryString("car_nombre").ToString
        Me.eje_ano_def.Text = Me.Request.QueryString("eje_ano_def").ToString
        Me.tip_cla_mat_nombre.Text = Me.Request.QueryString("tip_cla_mat_nombre").ToString
        Me.tipo_conteo.Text = Me.Request.QueryString("tipo_conteo").ToString
        configura_reporte()
