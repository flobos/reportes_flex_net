<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_contrato_ingreso_inscripcion.aspx.vb" Inherits="frm_contrato_ingreso_inscripcion" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="reportes\rpt_contrato_ingreso_inscripcion.rpt">
                <Parameters>
